...
<script>
  ...
  export default {
      ...
      created () {
          this.fetchBrokerCheckList()
      },

      methods: {

          fetchBrokerCheckList() {
            http({
                url: Api.brokerCheckList,
                method: "post",
                data: {
          ...
          //查看详情
          show(row) {
              this.$router.push({ name: 'showBrokerCheck', params: {"id": row.id} })
          },
